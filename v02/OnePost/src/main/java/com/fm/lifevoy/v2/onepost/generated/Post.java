 ...
 *         &lt;element name="comments" type="{http://www.fm.com/lifevoy/v2/onepost}Comment" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "Post", namespace = "http://www.fm.com/lifevoy/v2/onepost", propOrder = {
    "postID",
    "text",
    "posterUsername",
    "likers",
...
public class Post {
    ...
    @XmlElement(namespace = "http://www.fm.com/lifevoy/v2/onepost")
