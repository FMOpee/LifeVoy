 ...
 *         &lt;element name="likerUsernames" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "Post", namespace = "http://fm.com/lifevoy/v2/post", propOrder = {
    "postID",
    "posterUsername",
    "text",
    "likerUsernames"
...
public class Post {
    ...
    @XmlElement(namespace = "http://fm.com/lifevoy/v2/post", required = true)
    protected List<String> likerUsernames;
    ...
    /**
     * Gets the value of the likerUsernames property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the likerUsernames property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getLikerUsernames().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<String> getLikerUsernames() {
        if (likerUsernames == null) {
            likerUsernames = new ArrayList<String>();
        }
        return this.likerUsernames;
    }
